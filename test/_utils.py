"""
This *_utils* module for using by package testing.
"""


class MessageQueueSystemHost:
    """Utils about message queue system: RabbitMQ, ActiveMQ"""

    @classmethod
    def get_rabbitmq_ip_and_port(cls) -> [str, str]:
        """
        ...
        _rabbitmq_ip, _rabbitmq_port = cls.__parse_host_to_ip_and_port(hosts=RabbitMQ_Hosts)
        return _rabbitmq_ip, _rabbitmq_port


    @classmethod
    def get_activemq_ip_and_port(cls) -> [str, str]:
        """
        ...
        _activemq_ip, _activemq_port = cls.__parse_host_to_ip_and_port(hosts=ActiveMQ_Hosts)
        return _activemq_ip, _activemq_port


    @classmethod
    def __parse_host_to_ip_and_port(cls, hosts: str) -> [str, str]:
        """
